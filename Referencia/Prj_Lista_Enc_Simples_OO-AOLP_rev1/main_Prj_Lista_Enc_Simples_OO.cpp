...
/* Nas aulas e com a leitura do material "Cap. 10", iniciamos a implementação de uma biblioteca prototipada OO em um projeto com "main" com métodos básicos. Logo, faça:
...
int main(int argc, char** argv) {
	...
	Lista l;
 //cria objeto teste usando o construtor polim?rfico sem par?metros	
 	l.insere_inicio(23);
 	l.insere_inicio(45);
 	l.insere_inicio(56);
 	l.insere_inicio(78);
